...
def parse_request_sensor_manager(data):
	...
	app_config_field_list = [app_config_username, app_config_applicationname, app_config_servicename, app_config_serviceid, app_config_latitude, app_config_longitude, app_config_config_file]
	...
	return correctly_parsed_outer_json, values[0], values[1], values[2], values[3], values[4], values[5], values[6], not_correct_list
